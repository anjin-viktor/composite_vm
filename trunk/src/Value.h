...
**/
		Value();
/**
Конструктор от значения. Переменная инициализируется указанным значением, её типом становится минимальный тип, покрывающий
...
/**
Преобразует запись типа в виде строки к виду Value::ValueType.
